  ...
  return (
    ...
    >
      <div className="flex flex-col gap-4">
        ...
        <div>
          <p className="font-bold text-slate-800 group-hover:text-white transition-colors duration-500">{title}</p>
          <p className="text-[11px] text-slate-500 group-hover:text-white/80 transition-colors duration-500">{desc}</p>
        </div>
      </div>
    </div>
  )
